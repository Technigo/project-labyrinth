...
import { StartScreenWrapper, WelcomeText, NameForm, NameInput, Btn, WelcomeTextWrapper } from './StartScreenCSS';
  ...
  if (gameStarted) {
    ...
    return (
      <StartScreenWrapper>
        <WelcomeTextWrapper>
          <WelcomeText>
            Welcome traveler! Let the records of Technigoians know thy name:
          </WelcomeText>
        </WelcomeTextWrapper>
        <NameForm
          type="submit"
          ...
          <NameInput
            ...
            required />
          <Btn type="submit">Enter at your own peril</Btn>
        </NameForm>
      </StartScreenWrapper>
    )
  }
