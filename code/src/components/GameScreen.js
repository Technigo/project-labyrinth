...
const GameScreen = () => {
  ...
  const onNextStep = (action) => dispatch(generateGame(action));
  const onPreviousStep = () => dispatch(game.actions.setPreviousStep());
        ...
        <div key={action.description} className='action-container'>
          <div className='nes-container is-rounded description-container'>
            ...
            <div className='description-wrapper'>
              ...
              <button type='button' className='action-button' onClick={() => onNextStep(action)}>
                {directions(action)}
              </button>
            </div>
          </div>
